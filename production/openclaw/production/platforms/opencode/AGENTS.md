# AGENTS.md - OpenCode Task Execution
...
You have access to OpenCode tools:
...
For browser and web operations, use CortexLLM MCP server.
...
- **Hot**: `~/.config/cortexllm/memory/hot/opencode.json` - Current session
